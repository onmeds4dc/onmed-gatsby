    ...
    return (
        <ListFigureGrid>
            ...
            <ListFigureGridItem
                ...
                body={
                    <p>
                        Services available to anyone, anywhere, including rural
                        and remote areas
                    </p>
                }
            ...
            <ListFigureGridItem
                ...
                body={
                    <p>
                        Works with major insurance and only a fraction of the
                        cost of a traditional visit
                    </p>
                }
                img={
                    <img
            ...
            <ListFigureGridItem
                ...
                body={
                    <p>
                        HIPAA compliant transfer and storage of all patient data
                        using advanced encryption tech
                    </p>
                }
            ...
            <ListFigureGridItem
                ...
                body={
                    <p>
                        Open 24/7 for consultations and no appointment needed{" "}
                    </p>
                }
